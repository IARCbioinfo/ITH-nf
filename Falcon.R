...
path_to_germline_coverage_VCF = args[1]
patient_id         = args[2]
...
## Set parameters
##########################################
file_name = basename(path_to_germline_coverage_VCF)
##########################################
...
VCF_germline_content = read.table(path_to_germline_coverage_VCF, sep="\t", header=FALSE, stringsAsFactors=FALSE)
